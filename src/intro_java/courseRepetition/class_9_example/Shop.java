...
public class Shop {
     ...
     */
    private intro_java.class_9_practice.factory_example.Product[] productToSell; // default value is null
    /**
    ...
    public Shop(int maxCapacity) {
        productToSell = new intro_java.class_9_practice.factory_example.Product[maxCapacity]; // array creation
    }
     ...
     */
    public void addGoodsToShop(intro_java.class_9_practice.factory_example.Product product) {
     ...
     */
    public intro_java.class_9_practice.factory_example.Product sellLastAddedProduct() {
        ...
        intro_java.class_9_practice.factory_example.Product lastElement = productToSell[currentProductIndex];
     ...
     */
    public intro_java.class_9_practice.factory_example.Product sellProductByName(String name) {
        for (int i = 0; i < productToSell.length; i++) {
            intro_java.class_9_practice.factory_example.Product currentProduct = productToSell[i];
     ...
     */
    private void sellProduct(intro_java.class_9_practice.factory_example.Product product) {
